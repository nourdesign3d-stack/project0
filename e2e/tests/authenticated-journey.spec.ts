 ...
 *
 * Ce parcours vit dans son **propre fichier** parce que `video` et `screenshot`
 * sont des options de *worker* : Playwright refuse `test.use` les portant dans
 * un `describe` et exige le niveau fichier — constaté en CI le 2026-08-07.
 * Les autres fichiers conservent trace, vidéo et captures : ils n'émettent que
