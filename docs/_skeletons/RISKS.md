...
| R-006 | Build complet impossible sans `BASEHUB_TOKEN` : `apps/web` n'est pas couvert par la CI par défaut | moyenne | haute | job `build-full` conditionnel documenté dans `DEPLOYMENT.md` | à désigner | atténué |
